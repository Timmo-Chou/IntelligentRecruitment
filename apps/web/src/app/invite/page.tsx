...
export default function InvitePage() {
  const token = useSearchParams().get("token"); const router = useRouter(); const { refresh } = useTenant(); const [busy, setBusy] = useState(false); const [message, setMessage] = useState<string | null>(null);
