...
export default function InterviewsPage() {
  ...
  async function load() {
    ...
    setLoading(true);
    try { setKits(await apiFetch<Kit[]>(`/tenants/${workspaceId}/interview-kits`)); }
  ...
  async function open(kit: Kit) { if (workspaceId) setDetail(await apiFetch<KitDetail>(`/tenants/${workspaceId}/interview-kits/${kit.id}`)); }
