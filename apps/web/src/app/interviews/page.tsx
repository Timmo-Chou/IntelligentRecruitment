...
export default function InterviewsPage() {
  ...
  async function load() {
    if (!tenantId) return;
    setLoading(true);
    try { setKits(await apiFetch<Kit[]>(`/tenants/${tenantId}/interview-kits`)); }
  ...
  async function open(kit: Kit) { if (tenantId) setDetail(await apiFetch<KitDetail>(`/tenants/${tenantId}/interview-kits/${kit.id}`)); }
